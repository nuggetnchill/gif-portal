          ...
          <div className="gif-grid">
            {gifList.map((item, index) => (
              <div className="gif-item" key={index}>
                ...
                <p className="submit-addy">
                  Submited by{" "}
                  <a
                    target="_blank"
                    href={`https://explorer.solana.com/address/${item.userAddress.toString()}?cluster=devnet`}
                  >
                    {item.userAddress.toString().slice(0, 4)}
                    ...
                    {item.userAddress.toString().slice(-4, -1)}
                  </a>
                </p>
              </div>
            ))}
    ...
    <div className="App">
      <div className={walletAddress ? "authed-container" : "container"}>
        <div className="header-container">
          <p className="header"> Pug Portal</p>
          <p className="sub-text">
            Pugs that live in the metaverse ✨
          </p>
